                ...
                <nav class="MuiList-root menuList MuiList-padding">
                  <div v-if="role == 'SHIPPER'"
                    ...
                    <div class="MuiListItemText-root menuItemTitle">
                      <span @click="navigateTo('danh-sach-don')"
                  ...
                  <div v-if="role == 'SHIPPER'"
                    ...
                    <div class="MuiListItemText-root menuItemTitle">
                      <span @click="navigateTo('danh-sach-don-da-nhan')"
                        class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Đơn
                        đã nhận</span>
                    </div>
                  </div>
                  <div v-if="role == 'SHIPPER'"
                    ...
                    <div class="MuiListItemText-root menuItemTitle">
                      <span @click="navigateTo('danh-sach-don-da-giao')"
                        class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Đơn
                        đã giao</span>
                    </div>
                  </div>
                      ...
                      <div class="MuiCollapse-wrapperInner jss187">
                        <div class=" jss243 menuListSubMenuItem menuListSubMenuItemLevel-0">
                          <a class="MuiButtonBase-root MuiListItem-root jss186 rootMenuItem MuiListItem-gutters MuiListItem-button"
                            ...
                            <div class="MuiListItemText-root menuItemTitle">
                              <span
                                class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Tạo
                                đơn và giao hàng
                              </span>
                            </div>
                          </a><a
                            ...
                            class="MuiButtonBase-root MuiListItem-root jss186 rootMenuItem MuiListItem-gutters MuiListItem-button"
                            tabindex="0" role="button" aria-disabled="false" href="/admin/order_returns">
                            <div class="MuiListItemText-root menuItemTitle">
                              <span
                                class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Khách
                                trả hàng
                              </span>
                            </div>
                          </a>
                      ...
                      <div class="MuiCollapse-wrapperInner jss187">
                        <div class=" jss244 menuListSubMenuItem menuListSubMenuItemLevel-0">
                          <a class="MuiTypography-root MuiLink-root MuiLink-underlineHover MuiButtonBase-root MuiListItem-root jss186 rootMenuItem MuiListItem-gutters MuiListItem-button MuiTypography-colorPrimary"
                            ...
                            <div class="MuiListItemText-root menuItemTitle">
                              <span
                                class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Tổng
                                quan
                              </span>
                            </div>
                          </a>
                  ...
                  <div v-if="role == 'ADMIN'"
                    ...
                    <div class="MuiListItemText-root menuItemTitle">
                      <span @click="navigateTo('admin-store')"
                        class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Danh
                        sách cửa hàng</span>
                    </div>
                  </div>
                  <div v-if="role == 'ADMIN'"
                    ...
                    <div class="MuiListItemText-root menuItemTitle">
                      <span @click="navigateTo('admin-account')"
                        class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Danh
                        sách tài khoản</span>
                    </div>
                  </div>
                  <div v-if="role == 'MANAGER'"
                    ...
                    tabindex="0" role="button" aria-disabled="false">
                    <div class="MuiListItemIcon-root">
                      <img style="width: 30px" src="../../public/payment.png" alt="" srcset="" />
                    </div>

                    <div class="MuiListItemText-root menuItemTitle">
                      <span @click="navigateToExport(storeId.storeId)"
                        class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Hóa
                        đơn</span>
                    </div>
                  </div>
                  <div v-if="role == 'MANAGER'"
                    ...
                    <div class="MuiListItemText-root menuItemTitle">
                      <span @click="navigateToCustomer(storeId.storeId)"
                        class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Khách
                        hàng</span>
                    </div>
                  </div>
                  <div v-if="role == 'MANAGER'"
                    ...
                    tabindex="0" role="button" aria-disabled="false">
                    <div class="MuiListItemIcon-root">
                      <img style="width: 30px" src="../../public/salary.png" alt="" srcset="" />
                    </div>

                    <div class="MuiListItemText-root menuItemTitle">
                      <span @click="navigateToRevenue(storeId.storeId)"
                        class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Doanh
                        thu</span>
                    </div>
                  </div>
                  <div v-if="role == 'MANAGER'"
                    ...
                    tabindex="0" role="button" aria-disabled="false">
                    <div class="MuiListItemIcon-root">
                      <img style="width: 30px" src="../../public/products.png" alt="" srcset="" />
                    </div>

                    <div class="MuiListItemText-root menuItemTitle">
                      <span @click="navigateToProduct(storeId.storeId)"
                        class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Sản
                        phẩm</span>
                    </div>
                  </div>
                  <div v-if="role == 'MANAGER'"
                    ...
                    tabindex="0" role="button" aria-disabled="false">
                    <div class="MuiListItemIcon-root">
                      <img style="width: 30px" src="../../public/order-now.png" alt="" srcset="" />
                    </div>

                    <div class="MuiListItemText-root menuItemTitle">
                      <span @click="navigateToOrder(storeId.storeId)"
                        class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Đơn
                        hàng</span>
                    </div>
                  </div>
                      ...
                      <div class="MuiCollapse-wrapperInner jss187">
                        <div class=" jss252 menuListSubMenuItem menuListSubMenuItemLevel-0">
                          <a class="MuiButtonBase-root MuiListItem-root jss186 rootMenuItem MuiListItem-gutters MuiListItem-button"
                            ...
                            class="MuiButtonBase-root MuiListItem-root jss186 rootMenuItem MuiListItem-gutters MuiListItem-button"
                            tabindex="0" role="button" aria-disabled="false" href="/admin/customer_groups">
                            <div class="MuiListItemText-root menuItemTitle">
                              <span
                                class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">Nhóm
                                khách hàng
                              </span>
                            </div>
                          </a>
...
.MuiLinearProgress-dashedColorPrimary {
  ...
  background-image: radial-gradient(rgb(158, 209, 255) 0%,
      rgb(158, 209, 255) 16%,
      transparent 42%);
...
.MuiLinearProgress-dashedColorSecondary {
  background-size: 10px 10px;
  background-image: radial-gradient(rgb(202, 205, 209) 0%,
      rgb(202, 205, 209) 16%,
      transparent 42%);
  background-position: 0px -23px;
}
...
.jss115 {
  background-image: /images/dashboard/frame.png;
}
...
.jss274 {
  ...
  background: url(https://sapo.dktcdn.net/sapo-frontend-v3/master/static/media/6f2d8a7e4d0034640555.png) top left no-repeat,
    url(https://sapo.dktcdn.net/sapo-frontend-v3/master/static/media/f6083db7e88697072ad0.png) bottom right no-repeat !important;
}
...
<style data-jss="" data-meta="DialogAffiliate">
.jss724 {
  top: 50px;
...
.jss769 li::before {
  ...
  background: url(https://sapo.dktcdn.net/sapo-frontend-v3/master/static/media/4f9d197f29b84845d750.svg) no-repeat 0 0;
}
...
.jss771 {
  ...
  background-image: url(https://sapo.dktcdn.net/sapo-frontend-v3/master/static/media/0c852a7698b8736c335e.png);
}
...
.jss678:first-child {
  padding-right: calc(16px * 2 / 3);
}

.jss678:last-child {
  padding-left: calc(16px * 2 / 3);
}

.jss678:nth-child(2) {
  padding: 0 calc(16px * 1 / 3);
}
...
.jss426.info-right-collapse {
  width: calc((100vw - 52px - 32px * 2 - 24px * 3) / 4);
}
...
.jss428 .button-download.language-th {
  top: 149px;
  left: 10px;
  width: 280px;
}

.jss428 .button-download .button-download-android,
.jss428 .button-download .button-download-ios {
  width: 132px;
  cursor: pointer;
  height: 100%;
  display: inline-block;
...
.jss428 .button-download.language-th .button-download-android,
.jss428 .button-download.language-th .button-download-ios {
  width: 138px;
}
...
.jss428 .button-close-dialog svg {
  color: #0089ff;
  width: 30px;
  height: 30px;
}
...
.jss429 .button-close-dialog svg {
  color: #0089ff;
  width: 30px;
  height: 30px;
}
...
.jss430 .content-interconnection-pharmacy {
  height: 265px;
  display: grid;
  padding-top: 15px;
}

.jss431 .MuiDialogTitle-root {
  min-height: 56px;
}

.jss432 .MuiDialogTitle-root {
  min-height: 24px;
}

.jss432 .MuiDialogContent-dividers {
  border-top: none;
}

.jss432 .MuiDialogTitle-root .MuiTypography-root {
  display: none;
}

.jss433 {
  width: 320px;
  border: 0.5px dashed #0fd186;
  height: 52px;
  display: inline-block;
  background: #f3fcf9;
  margin-top: 16px;
...
.jss436 .MuiIconButton-root:hover {
  background: none;
}
