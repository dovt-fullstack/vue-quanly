        ...
        <div class="card" v-if="userData">
          ...
          <div class="card-body">
            ...
            <div class="user-info">
              ...
              <p>
                <strong>Địa chỉ:</strong> {{ userData.phoneNumber || "N/A" }}
              </p>
              <p>
                <strong>Mạng xã hội:</strong>
                {{ userData.socialContact || "N/A" }}
              </p>
            </div>
          </div>
          ...
          <a-form :form="form" layout="vertical">
            <a-form-item label="Họ">
              <a-input
                ...
                @input="handleInputChange('firstname', $event)"
              />
            </a-form-item>
            <a-form-item label="Tên">
              <a-input
                v-model:value="formData.lastname"
                @input="handleInputChange('lastname', $event)"
              />
            </a-form-item>
            <a-form-item label="Số điện thoại">
              <a-input
                v-model:value="formData.phoneNumber"
                @input="handleInputChange('phoneNumber', $event)"
              />
            </a-form-item>
  ...
  setup() {
    ...
    const getUserData = async () => {
      try {
        ...
        const response = await axios.get(
          "https://charismatic-friendship-production.up.railway.app/api/v1/account/profile/view",
          {
            headers: {
    ...
    const handleOk = async () => {
      try {
        ...
        await axios.put(
          "https://charismatic-friendship-production.up.railway.app/api/v1/account/profile/update",
          formData2,
          {
            headers: {
...
/* Optional: Specific styling for input labels */
.ant-form-item-label {
  font-weight: bold;
}
.card {
